...
| A003  | Server overload                    | 500            |
| A004  | Protocol violation                 | 400            |
| A005  | Service unavailable                | 503            |
| A005(1) | Service outdated                 | 503            |
| A005(2) | Service unimplemented on version | 503            |
| A005(3) | Service unsupported on browser   | 503            |
...
currently only A001 is fully operational but expect the others in the future
# system_log
-----
| Version | Changes |
|---------|---------|
